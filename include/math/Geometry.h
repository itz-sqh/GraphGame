...
namespace Geometry {
    ...
    sf::Vector2f mapToWindow(sf::Vector2f pos, sf::Vector2u size, float minX = GameConstants::MIN_X,
                             float maxX = GameConstants::MAX_X, float minY = GameConstants::MIN_Y,
                             float maxY = GameConstants::MAX_Y);

    float mapToWindow(float value, unsigned sizeX, float minX = GameConstants::MIN_X,
                      float maxX = GameConstants::MAX_X);
