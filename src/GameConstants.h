...
namespace GameConstants {
    constexpr double MAX_X = 25;
    constexpr double MIN_X = -25;
    constexpr double MAX_Y = 15;
    constexpr double MIN_Y = -15;
    constexpr double POINTS_STEP = 0.025;
    ...
    constexpr float DISTANCE_BETWEEN_PLAYER_AND_OBSTACLE = OBSTACLE_RADIUS;
